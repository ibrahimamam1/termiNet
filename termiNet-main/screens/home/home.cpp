...
Home::Home(QWidget *parent) : QMainWindow(parent), user(UserModel::getInstance())
{
    ...
    logo->setPixmap(QPixmap("../../assets/logo"));
    ...
    createPostIcon->setPixmap(QPixmap("../../assets/createPost"));
    ...
    messageIcon->setPixmap(QPixmap("../../assets/messageIcon"));
    ...
    profileIcon->setPixmap(QPixmap("../../assets/profileIcon"));
    ...
    communityNav->addWidget(communityLabel, 1);
    communityNav->addStretch(9);
